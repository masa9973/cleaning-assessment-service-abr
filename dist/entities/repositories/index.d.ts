...
export declare class RepositoryContainer {
    ...
    constructor(s3Repository: IS3Repository, userMastRepository: IUserMastRepository, recordMastRepository: IRecordMastRepository, scoreMastRepository: IScoreMastRepository, roomMastRepository: IRoomMastRepository, scoreItemMastRepository: IScoreItemMastRepository);
}
